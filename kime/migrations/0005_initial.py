...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('kime_project', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('deadline', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('kime', ['Project'])

        # Adding M2M table for field users on 'Project'
        db.create_table('kime_project_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm['kime.project'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('kime_project_users', ['project_id', 'user_id'])

        # Adding model 'TimeEntry'
        db.create_table('kime_timeentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('kime', ['TimeEntry'])


    def backwards(self, orm):
        # Deleting model 'Project'
        db.delete_table('kime_project')

        # Removing M2M table for field users on 'Project'
        db.delete_table('kime_project_users')

        # Deleting model 'TimeEntry'
        db.delete_table('kime_timeentry')
